...
FEATS_DIM = 180
K = 2
ALPHA = 0.83                     # changed from 0.92 to 0.83 for CN vs AD
NUM_EPOCHS = 5000
N_EVAL_PASSES = 30
NUM_RUNS = 10

# ============================================================================
# DATA LOADING – CN vs AD
# ============================================================================
...
# ============================================================================
# HELPER FUNCTIONS (unchanged except for AD labels)
# ============================================================================
...
# ============================================================================
# MC EVALUATION (with dropout, feature/edge perturbations, label alignment)
# ============================================================================
...
# ============================================================================
# UNCERTAINTY AND METRICS FUNCTIONS
# ============================================================================
def entropy_bits(p):
...
# ============================================================================
# MAIN: 10‑RUN EVALUATION (CN vs AD)
# ============================================================================
all_results = []
last_yp = None
last_H_assign = None
...
print("========================================================================")
print("  ARMA (modularity only) with MC uncertainty – CN vs AD")
...
# ============================================================================
# HORIZONTAL TABLE FOR MANUSCRIPT (mean ± std)
# ============================================================================
print("\n" + "========================================================================")
...
if last_logits_stack is not None:
    ...
    label_map = {0: "CN", 1: "AD"}   # changed for CN vs AD
    df = pd.DataFrame({
    ...
    df.to_csv("arma_modularity_cn_vs_ad_uncertainty_last_run.csv", index=False, float_format="%.6f")
    print(f"\n   Saved per-subject uncertainty to arma_modularity_cn_vs_ad_uncertainty_last_run.csv")

# ============================================================================
# FINAL SUMMARY
# ============================================================================
print(f"\n{'='*60}")
print(f"  ARMA (modularity only) - Final Summary ({NUM_RUNS} runs, weighted metrics) – CN vs AD")
print(f"{'='*60}")
...
df_all.to_csv("arma_modularity_cn_vs_ad_10run_weighted_summary.csv", index=False, float_format="%.6f")
print(f"\n   Saved 10-run weighted summary -> arma_modularity_cn_vs_ad_10run_weighted_summary.csv")
print(f"{'='*60}\n  ANALYSIS COMPLETE\n{'='*60}")
