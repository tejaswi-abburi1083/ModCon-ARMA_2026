...
# ===========================================================================
#  DATA LOADING (fixed permutation across runs) – CN vs AD
# ===========================================================================
...
print("═" * 72)
print(f"  ARMA (original design) with MC uncertainty – CN vs AD")
...
if last_logits_stack is not None:
    ...
    df.to_csv("arma_original_cn_vs_ad_uncertainty_last_run.csv", index=False, float_format="%.6f")
    print(f"\n  ✓ Saved per-subject uncertainty to arma_original_cn_vs_ad_uncertainty_last_run.csv")

# ============================================================================
#  FINAL SUMMARY (weighted metrics)
# ============================================================================
print(f"\n{'='*60}")
print(f"  ARMA (original design) — Final Summary ({NUM_RUNS} runs, weighted metrics) – CN vs AD")
print(f"{'='*60}")
...
df_all.to_csv("arma_original_cn_vs_ad_10run_weighted_summary.csv", index=False, float_format="%.6f")
print(f"\n  ✓ Saved 10‑run weighted summary → arma_original_cn_vs_ad_10run_weighted_summary.csv")
print(f"{'='*60}\n  ANALYSIS COMPLETE\n{'='*60}")
