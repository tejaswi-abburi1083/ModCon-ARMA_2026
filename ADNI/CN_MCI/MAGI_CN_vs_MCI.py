...
EDGE_DROP_MIN = 0.15
EDGE_DROP_STEP = 0.10
ALPHA = 0.92                # graph adjacency threshold (cosine similarity)
...
# =============================================================================
# DATA: CN vs MCI (FA histograms, 20 bins)
# =============================================================================
...
# =============================================================================
print(f"\n{'═'*72}")
print(f"  MAGI (faithful) + K‑Means — CN vs MCI (α={ALPHA})")
...
df_unc.to_csv("magi_cn_mci_uncertainty_run1.csv", index=False, float_format="%.6f")
print(f"\n  CSV → magi_cn_mci_uncertainty_run1.csv")
...
sep100 = "─" * 100
print(f"\n{sep100}")
print(f"  {N_RUNS}-RUN SUMMARY (mean ± std) — MAGI (CN vs MCI, α={ALPHA})")
print(f"{sep100}")
...
df_weighted_summary.to_csv("magi_cn_mci_weighted_summary.csv", index=False, float_format="%.6f")
print(f"\n  ✓ Saved weighted summary → magi_cn_mci_weighted_summary.csv")
