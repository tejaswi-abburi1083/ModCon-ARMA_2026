...
print("=" * 72)
print("K-MEANS BASELINE – CN vs MCI (10 runs with std)")
print("=" * 72)
...
df_results.to_csv("kmeans_10run_summary.csv", index=False, float_format="%.4f")
print("\nSaved results to: kmeans_10run_summary.csv")
