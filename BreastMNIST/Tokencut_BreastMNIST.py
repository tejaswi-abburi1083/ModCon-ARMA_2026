...
print("═" * 72)
print("  TOKENCUT BASELINE – BreastMNIST (RadioDINO features)")
print("  NOTE: Diagnostic labels used ONLY for post-hoc external validation.")
print("═" * 72)
...
# ═══════════════════════════════════════════════════════════════════════════
print("\n" + "═" * 72)
print("  10-RUN SUMMARY (mean ± std)                         [TokenCut, BreastMNIST]")
print("  NOTE: Diagnostic labels used only for post-hoc external validation.")
print("═" * 72)
...
df_summary.to_csv("tokencut_breastmnist_10run_summary.csv", index=False, float_format="%.6f")
print("\n  ✓ Saved 10‑run summary to tokencut_breastmnist_10run_summary.csv")
